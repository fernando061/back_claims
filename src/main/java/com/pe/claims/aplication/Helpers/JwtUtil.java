...
public class JwtUtil {
    ...
    private final String SECRET_KEY = "uL7lGqs+ztZRnjRcovH4gzLZ6kivE0vUggvXLx8FnyY=";
    ...
    public String generateToken(String username,String documentNumber) {
        return Jwts.builder()
                .setSubject(username)
                ...
                .signWith(key) // Firma el token con la clave
                .compact();
    }
