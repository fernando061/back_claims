...
public class CustomerController {
    ...
    public ResponseEntity<LoginUserResponseDto> LoginCustomer(@RequestBody LoginUserRequestDto loginClient){
    ...
    public ResponseEntity<LoginUserResponseDto> checkToken(HttpServletRequest request){
